...
import com.dream.demo.cvc.exception.CVBufferNotEmptyException;
import com.dream.demo.cvc.exception.CVDecodeErrorException;
import com.dream.demo.cvc.exception.CVInvalidECPointLengthException;
...
import com.dream.demo.cvc.exception.CVTagNotFoundException;
import com.dream.demo.cvc.exception.CVUnknownAlgorithmException;
import com.dream.demo.cvc.exception.CVUnknownCryptoProviderException;
        ...
        switch (m_algorithmType) {
            case RSA_v1_5_SHA_1:
                TLV.append(out, CVCertificate.s_CvOIDTag,
                        Oids.concat(Oids.OID_BSI_DE, oidPart, Oids.OID_RSA_v1_5_SHA_1));
                break;
            ...
            case RSA_PSS_SHA_1:
                TLV.append(out, CVCertificate.s_CvOIDTag,
                        Oids.concat(Oids.OID_BSI_DE, oidPart, Oids.OID_RSA_PSS_SHA_1));
                break;
            ...
            case ECDSA_SHA_1:
                TLV.append(out, CVCertificate.s_CvOIDTag,
                        Oids.concat(Oids.OID_BSI_DE, oidPart, Oids.OID_ECDSA_SHA_1));
                break;
            case ECDSA_SHA_224:
                TLV.append(out, CVCertificate.s_CvOIDTag,
                        Oids.concat(Oids.OID_BSI_DE, oidPart, Oids.OID_ECDSA_SHA_224));
                break;
            case ECDSA_SHA_256:
                TLV.append(out, CVCertificate.s_CvOIDTag,
